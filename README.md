...
This repository contains data summaries, fecundity GLMMs, and coexistence analyses for the WA annual plant coexistence project.

The GLMMs test statistical support for fecundity responses to site, cover, density, and facilitator effects. The coexistence models use demographic model estimates to evaluate whether those effects translate into predicted coexistence, priority effects, or competitive exclusion.
